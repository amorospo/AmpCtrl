...
<form method="post" action="formvar.php">
  ...
  9 Inserisci il valore in Ampere sotto il quale inviare un messaggio di allarme impianto spento (default: 0)<br>
  <input type="number" name="Sw_Off" size="60" value="<?php echo $Sw_Off;?>"><br><br>
  10 Inserisci il valore in Ampere sotto il quale inviare un messaggio di allarme corrente assorbita bassa (default: 1)<br>
  <input type="number" name="LowA" size="60" value="<?php echo $LowA;?>"><br><br>
  11 Inserisci il valore in Ampere sotto il quale inviare un messaggio di allarme corrente assorbita alta (default: 14)<br>
  <input type="number" name="HiA" size="60" value="<?php echo $HiA;?>"><br><br>
